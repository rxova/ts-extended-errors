// https://rxova.org/packages/ts-extended-errors/llms.txt — the agent-facing index.
//
...
export const GET: APIRoute = async () => {
  ...
  // /packages/ts-extended-errors/, and a URL that dropped that prefix would 404 in the one
