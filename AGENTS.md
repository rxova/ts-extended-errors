...
| `apps/docs/src/content/docs/**`         | People and agents on rxova.org; each page but the splash home page serves a `.md` twin | The docs build: `starlight-links-validator`, then `check-md-routes.mjs` over the emitted dist         |
